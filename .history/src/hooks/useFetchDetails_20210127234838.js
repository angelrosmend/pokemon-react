...
export const useFetchDetails = (urlPoke, language) => {
    ...
    useEffect(() => {
        ...
        axios.get(urlPoke, {
             ...
             const {id, types, height, weight, stats, } = results
     /*  
             ...
             getPokemonData(urls, sprites, type).then(data => {
              ...
              let idPoke = data[0].id
               ...
               function gatherPokemonData(id, name, images, description, types, height, weight, stats) {
                 let data = []
               ...
               let pokemonInfo = gatherPokemonData(idPoke, name.name, images, description/*  sprites, description,types, height, weight,stats, habitat */)
