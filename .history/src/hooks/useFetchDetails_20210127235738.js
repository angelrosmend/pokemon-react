...
export const useFetchDetails = (urlPoke, language) => {
    ...
    useEffect(() => {
        ...
        axios.get(urlPoke, {
             ...
             const {id, types, height, weight, stats, s} = results
     /*  
             ...
             getPokemonData(urls, sprites, types).then(data => {
              ...
              let idPoke = data[0].id
               ...
               let pokemonInfo = gatherPokemonData(idPoke, name.name, images, description, types/*  sprites, description,types, height, weight,stats, habitat */)
